...
# Fixed Callback for Combined Day and Hour Analysis (using warehouse data)
# @app.callback(
...
#     for park_name, info in parks.items():
#         # Fixed: Use warehouse data instead of live data
...
# # Fixed Callback for Interval Timer (refresh global park data)
# @app.callback(
...
#     global park_data, park_warehouse_data
#     for park_name in parks.keys():
#         park_data[park_name] = load_park_data(park_name)
#         park_warehouse_data[park_name] = load_warehouse_data(park_name)  # Also refresh warehouse data
